...
<body class="bg-slate-800 w-screen justify-center h-screen flex flex-col gap-8">
  ...
  <main class="w-screen flex flex-col items-center gap-8">
    <form name="login" id="login" method="POST" action="login" class="max-w-sm w-11/12 flex flex-col gap-4">
   ...
   <span class="text-white mb-10">Need an account? <a class="font-bold cursor-pointer" href="./sign-up">Sign Up</a></span>
  </main>
</body>
